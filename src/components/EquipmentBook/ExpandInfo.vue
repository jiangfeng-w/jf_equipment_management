<template>
    <div class="equipment">
        ...
        <div class="info-container">
            ...
            <ul>
                <li class="info-row">
                    <span class="info-key">申请人学工号：</span>
                    <span class="info-value">{{ info.apply_number }}</span>
                </li>
                <li class="info-row">
                    <span class="info-key">申请人身份：</span>
                    <span class="info-value">{{ getRole(info.role) }}</span>
                </li>
                <li class="info-row">
                    <span class="info-key">申请人：</span>
                    <span class="info-value">{{ info.apply_name }}</span>
                </li>
                <li class="info-row">
